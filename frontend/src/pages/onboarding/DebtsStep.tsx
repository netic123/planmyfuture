      ...
      <div className="space-y-4">
        ...
        {showForm ? (
          <div className="space-y-3 p-4 border border-neutral-700 rounded-xl">
            <div>
              <label className="text-sm text-white/70 mb-1 block">{t('onboarding.debts.debtType')}</label>
              <select
                value={newDebt.type}
            ...
            <div>
              <label className="text-sm text-white/70 mb-1 block">{t('onboarding.debts.amount')}</label>
            ...
            <div>
              <label className="text-sm text-white/70 mb-1 block">{t('onboarding.debts.interest')} (0 om ingen)</label>
